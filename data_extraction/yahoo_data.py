...
BTCEUR = pd.read_csv("BTC-EUR (1).csv")
...
cursor.execute('''CREATE TABLE IF NOT EXISTS "Donnée historique" (
...
for file in csv_files:
    ...
    df.to_sql("Donnée historique", conn, if_exists="append", index=False)
